...
function Tablero() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            ...
            <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-2xl shadow bg-gradient-to-r from-blue-600 to-indigo-600">
                <div>
                ...
                <button
                    ...
                    className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition-colors hover:scale-105 transition-transform"
                >
                    Cerrar sesión
                </button>
            </div>
            ...
            <div className="flex gap-2 mb-4 flex-wrap">
                {['Todas', 'Pendiente', 'En Progreso', 'Completada'].map(estado => (
                    <button
                        ...
                        className={`px-4 py-1 rounded-full text-sm font-medium transition-colors ${filtro === estado
            ...
            <button
                ...
                className="mb-4 bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors hover:scale-105 transition-transform"
            >
            ...
            {mostrarForm && (
                <form onSubmit={handleSubmit} className="bg-white p-4 rounded-2xl shadow mb-6 flex flex-col gap-3">
                    ...
                    <input
                        ...
                        placeholder="Título"
                        className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:bg-blue-50 focus:ring-blue-500"
                    />
                    <input
                        name="descripcion"
                    ...
                    <button
                        type="submit"
                        className="bg-blue-600 text-white py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors hover:scale-101 transition-transform"
                    >
                    ...
                    {tareasFiltradas.length === 0 ? (
                        ...
                        tareasFiltradas.map(tarea => (
                            ...
                            <div key={tarea.id} className="bg-white p-4 rounded-2xl shadow flex flex-col gap-2">
                                ...
                                <span className={`text-xs font-medium px-2 py-1 rounded-full w-fit ${tarea.estado === 'Completada' ? 'bg-green-100 text-green-700' :
                                ...
                                <div className="flex gap-2 mt-2">
                                    <button
                                        ...
                                        className="flex-1 bg-blue-500 text-white py-1 rounded-lg text-sm hover:bg-blue-600 transition-colors hover:scale-105 transition-transform"
                                    >
                                        Editar
                                    </button>
                                    <button
                                        onClick={() => handleEliminar(tarea.id)}
                                        className="flex-1 bg-red-500 text-white py-1 rounded-lg text-sm hover:bg-red-600 transition-colors hover:scale-105 transition-transform"
                                    >
                                        Eliminar
                                    </button>
                                </div>
